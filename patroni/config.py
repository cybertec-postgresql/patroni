...
class Config(object):
    ...
    def _validate_and_adjust_timeouts(self, config: Dict[str, Any]) -> None:
        ...
        retry_timeout = self. __get_and_maybe_adjust_int_value(config, 'retry_timeout', min_retry_timeout)
        ttl = self. __get_and_maybe_adjust_int_value(config, 'ttl', min_ttl)
